import svgPaths from "./svg-nk60vslked";
...
function Icon4() {
  return (
    <div className="absolute left-[16px] size-[16px] top-[14px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d="M13.3333 4.66667H7.33333" id="Vector" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M9.33333 11.3333H3.33333" id="Vector_2" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p2badb400} id="Vector_3" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p79fe00} id="Vector_4" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Button4() {
  return (
    <div className="h-[46px] relative rounded-tl-[8px] rounded-tr-[8px] shrink-0 w-[99.375px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon4 />
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[62px] not-italic text-[#6366f1] text-[14px] text-center top-[12px] whitespace-nowrap">Teknis</p>
      </div>
    </div>
  );
}
...
function Label() {
  return (
    <div className="h-[20px] relative shrink-0 w-[470.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">SUBDOMAIN (BAWAAN)</p>
      </div>
    </div>
  );
}
...
function TextInput() {
  return (
    <div className="bg-[#f8fafc] flex-[1_0_0] min-h-px relative rounded-[8px] w-[470.5px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[16px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">demo.jalawarta.com</p>
      </div>
...
function Label1() {
  return (
    <div className="h-[20px] relative shrink-0 w-[470.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">CUSTOM DOMAIN (optional)</p>
      </div>
    </div>
  );
}
...
function TextInput1() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[470.5px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[16px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">www.namaberita.com</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Label2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[470.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">ZONA WAKTU</p>
      </div>
    </div>
  );
}
...
function Dropdown() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[470.5px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-px pl-[-321px] pr-[791.5px] pt-[-441px] relative size-full">
        <Option />
        <Option1 />
        <Option2 />
      </div>
...
function Label3() {
  return (
    <div className="h-[20px] relative shrink-0 w-[470.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">BAHASA</p>
      </div>
    </div>
  );
}
...
function Dropdown1() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[470.5px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-px pl-[-815.5px] pr-[1286px] pt-[-441px] relative size-full">
        <Option3 />
        <Option4 />
      </div>
    </div>
...
function Checkbox() {
  return <div className="absolute left-0 size-[18px] top-[2px]" data-name="Checkbox" />;
}

function Text() {
  return (
    <div className="h-[20px] relative shrink-0 w-[363.172px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[20px] left-0 text-[#10151c] text-[14px] top-0 whitespace-nowrap">Visibilitas Mesin Pencari</p>
      </div>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-[363.172px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#64748b] text-[13px] top-0 whitespace-nowrap">Izinkan Google dan mesin pencari lain mengindeks situs ini.</p>
      </div>
    </div>
  );
}
...
function Container13() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] h-[44px] items-start left-[30px] top-0 w-[363.172px]" data-name="Container">
      <Text />
      <Text1 />
    </div>
  );
...
function Label4() {
  return (
    <div className="h-[44px] relative shrink-0 w-[965px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Checkbox />
        <Container13 />
      </div>
...
function Text2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[360.078px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[20px] left-0 text-[#10151c] text-[14px] top-0 whitespace-nowrap">Mode Pemeliharaan</p>
      </div>
    </div>
  );
}
...
function Container14() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] h-[44px] items-start left-[30px] top-0 w-[360.078px]" data-name="Container">
      <Text2 />
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-h-px not-italic relative text-[#64748b] text-[13px] w-[360px]">Sembunyikan situs dari publik sementara dalam perbaikan.</p>
    </div>
  );
}
...
function Label5() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-[965px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Checkbox1 />
        <Container14 />
      </div>
...
function Container12() {
  return (
    <div className="h-[100px] relative shrink-0 w-[965px]" data-name="Container">
...
function Label6() {
  return (
    <div className="h-[20px] relative shrink-0 w-[965px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">TEKS FOOTER</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[965px]" data-name="Text Area">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start px-[16px] py-[12px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[22px] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">© 2026 Demo Berita. Hak cipta dilindungi.</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container() {
  return (
    <div className="h-[838px] relative shrink-0 w-full" data-name="Container">
...
function App() {
  return (
    <div className="absolute content-stretch flex flex-col h-[838px] items-start left-0 pl-[256px] top-[73px] w-[1351px]" style={{ backgroundImage: "linear-gradient(rgb(248, 250, 252) 0%, rgb(246, 248, 251) 33.333%, rgb(243, 247, 250) 66.667%, rgb(241, 245, 249) 100%)" }} data-name="App">
      <Container />
    </div>
  );
}
...
function Navigation() {
  return (
    <div className="absolute h-[426px] left-0 top-[101px] w-[240px]" data-name="Navigation">
      <Link />
      <Button6 />
      <Button7 />
      <Button8 />
...
function Container25() {
  return (
    <div className="absolute content-stretch flex flex-col h-[97px] items-start left-0 pt-[17px] px-[16px] top-[816px] w-[255px]" data-name="Container">
...
function Sidebar() {
  return (
    <div className="absolute bg-[#0b3258] h-[913px] left-px overflow-clip top-0 w-[256px]" data-name="Sidebar">
      <Navigation />
      <Container25 />
      <Container29 />
      <Container30 />
...
export default function SettingTeknis() {
  return (
    <div className="bg-white relative size-full" data-name="setting/teknis">
      <App />
      <TopBar />
      <Sidebar />
    </div>
