import svgPaths from "./svg-3s6ix32d9h";
...
function Label() {
  return (
    <div className="content-stretch flex h-[16px] items-center relative shrink-0 w-full" data-name="Label">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] min-w-px not-italic relative text-[#64748b] text-[12px] tracking-[0.3px] uppercase">Nama Tag</p>
    </div>
  );
}
...
function UiButton() {
  return (
    <div className="bg-[#1976d2] h-[52px] relative rounded-[33554400px] shadow-[0px_10px_15px_0px_rgba(99,102,241,0.25),0px_4px_6px_0px_rgba(99,102,241,0.25)] shrink-0 w-full" data-name="UIButton">
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-[130.53px] not-italic text-[16px] text-center text-white top-[12px] whitespace-nowrap">Tambah Tag</p>
    </div>
  );
}
...
function TagsPage() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[160px] items-start relative shrink-0 w-full" data-name="TagsPage">
      <Container7 />
      <UiButton />
    </div>
  );
...
function Container3() {
  return (
    <div className="h-[317px] relative shrink-0 w-full" data-name="Container">
...
function UiCard() {
  return (
    <div className="bg-white h-[319px] relative rounded-[16px] shrink-0 w-full" data-name="UICard">
...
function Paragraph3() {
  return (
    <div className="h-[60px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold',sans-serif] font-bold leading-[60px] left-[130.56px] not-italic text-[#10151c] text-[60px] text-center top-[-4px] whitespace-nowrap">6</p>
    </div>
  );
}
...
function TagsPage1() {
  return (
    <div className="h-[252px] relative shrink-0 w-full" data-name="TagsPage">
      <div className="content-stretch flex flex-col gap-[12px] items-start pb-[32px] pt-[80px] px-[32px] relative size-full">
        <Paragraph2 />
        <Paragraph3 />
      </div>
    </div>
...
function UiCard1() {
  return (
    <div className="bg-white h-[254px] relative rounded-[16px] shrink-0 w-full" data-name="UICard">
      <div aria-hidden="true" className="absolute border border-[rgba(226,232,240,0.5)] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)]" />
      <div className="content-stretch flex flex-col items-start p-px relative size-full">
        <TagsPage1 />
      </div>
...
function Container2() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[597px] items-start left-0 top-0 w-[327.656px]" data-name="Container">
      <UiCard />
      <UiCard1 />
    </div>
  );
...
function TagsPage2() {
  return (
    <div className="bg-gradient-to-r from-[rgba(99,102,241,0.1)] h-[46px] relative rounded-[33554400px] shrink-0 to-[rgba(173,70,255,0.1)] w-[187.359px]" data-name="TagsPage">
...
function UiCardHeader1() {
  return (
    <div className="content-stretch flex h-[71px] items-start justify-between pb-[25px] relative shrink-0 w-full" data-name="UICardHeader">
      <div aria-hidden="true" className="absolute border-[rgba(226,232,240,0.5)] border-b border-solid inset-0 pointer-events-none" />
      <Container10 />
      <TagsPage2 />
    </div>
...
function Container14() {
  return (
    <div className="bg-[rgba(99,102,241,0.08)] relative rounded-[16px] shrink-0 size-[40px]" data-name="Container">
...
function Container15() {
  return (
    <div className="flex-[210.672_0_0] h-[40px] min-w-px relative" data-name="Container">
...
function Container13() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[12px] h-[76px] items-center left-0 p-[18px] rounded-[16px] top-0 w-[298.672px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[16px]" />
      <Container14 />
      <Container15 />
    </div>
...
function Container17() {
  return (
    <div className="bg-[rgba(139,92,246,0.08)] relative rounded-[16px] shrink-0 size-[40px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[10px] relative size-full">
        <Icon3 />
      </div>
    </div>
...
function Container16() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[12px] h-[76px] items-center left-[314.67px] p-[18px] rounded-[16px] top-0 w-[298.672px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[16px]" />
      <Container17 />
      <Container18 />
    </div>
...
function Container20() {
  return (
    <div className="bg-[rgba(6,182,212,0.08)] relative rounded-[16px] shrink-0 size-[40px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[10px] relative size-full">
        <Icon4 />
      </div>
    </div>
...
function Container19() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[12px] h-[76px] items-center left-0 p-[18px] rounded-[16px] top-[92px] w-[298.672px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[16px]" />
      <Container20 />
      <Container21 />
    </div>
...
function Container23() {
  return (
    <div className="bg-[rgba(16,185,129,0.08)] relative rounded-[16px] shrink-0 size-[40px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[10px] relative size-full">
        <Icon5 />
      </div>
    </div>
...
function Container22() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[12px] h-[76px] items-center left-[314.67px] p-[18px] rounded-[16px] top-[92px] w-[298.672px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[16px]" />
      <Container23 />
      <Container24 />
    </div>
...
function Container26() {
  return (
    <div className="bg-[rgba(245,158,11,0.08)] relative rounded-[16px] shrink-0 size-[40px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[10px] relative size-full">
        <Icon6 />
      </div>
    </div>
...
function Container25() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[12px] h-[76px] items-center left-0 p-[18px] rounded-[16px] top-[184px] w-[298.672px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[16px]" />
      <Container26 />
      <Container27 />
    </div>
...
function Container29() {
  return (
    <div className="bg-[rgba(239,68,68,0.08)] relative rounded-[16px] shrink-0 size-[40px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[10px] relative size-full">
        <Icon7 />
      </div>
    </div>
...
function Container28() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[12px] h-[76px] items-center left-[314.67px] p-[18px] rounded-[16px] top-[184px] w-[298.672px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[16px]" />
      <Container29 />
      <Container30 />
    </div>
...
function TagsPage3() {
  return (
    <div className="h-[260px] relative shrink-0 w-full" data-name="TagsPage">
      <Container13 />
      <Container16 />
      <Container19 />
      <Container22 />
...
function Container9() {
  return (
    <div className="h-[419px] relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col gap-[24px] items-start pt-[32px] px-[32px] relative size-full">
        <UiCardHeader1 />
        <TagsPage3 />
      </div>
...
function UiCard2() {
  return (
    <div className="bg-white h-[421px] relative rounded-[16px] shrink-0 w-full" data-name="UICard">
      <div aria-hidden="true" className="absolute border border-[rgba(226,232,240,0.5)] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)]" />
      <div className="content-stretch flex flex-col items-start p-px relative size-full">
        <Container9 />
      </div>
...
function Container8() {
  return (
    <div className="absolute content-stretch flex flex-col h-[597px] items-start left-[351.66px] top-0 w-[679.344px]" data-name="Container">
      <UiCard2 />
    </div>
  );
}
...
function Container1() {
  return (
    <div className="h-[597px] relative shrink-0 w-full" data-name="Container">
      <Container2 />
      <Container8 />
    </div>
  );
...
function DashboardLayout() {
  return (
    <div className="h-[822px] relative shrink-0 w-full" style={{ backgroundImage: "linear-gradient(148.682deg, rgb(248, 250, 252) 0%, rgb(248, 250, 252) 50%, rgba(241, 245, 249, 0.3) 100%)" }} data-name="DashboardLayout">
...
function Body() {
  return (
    <div className="absolute content-stretch flex flex-col h-[822px] items-start left-0 top-0 w-[1351px]" data-name="Body">
      <DashboardLayout />
    </div>
  );
}
...
function Text1() {
  return <div className="absolute bg-[#00c950] left-[16px] opacity-100 rounded-[33554400px] size-[8px] top-[12px]" data-name="Text" />;
}
...
function DashboardLayout2() {
  return (
    <div className="absolute bg-[#0b3258] content-stretch flex flex-col h-[822px] items-start left-0 pr-px top-0 w-[256px]" data-name="DashboardLayout">
...
function Icon19() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_2_8037)" id="Icon">
...
function NotificationPill() {
  return (
    <div className="relative rounded-[33554400px] shrink-0 size-[24px]" style={{ backgroundImage: "linear-gradient(135deg, rgb(251, 44, 54) 0%, rgb(255, 32, 86) 100%)" }} data-name="NotificationPill">
...
function NotificationPill1() {
  return (
    <div className="flex-[130.391_0_0] h-[20px] min-w-px relative" data-name="NotificationPill">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#9f0712] text-[14px] whitespace-nowrap">Nama tag harus diisi</p>
      </div>
    </div>
  );
}
      ...
      <div className="absolute inset-1/4" data-name="Vector">
        <div className="absolute inset-[-8.33%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.33333 9.33333">
            <path d={svgPaths.p48af40} id="Vector" stroke="var(--stroke-0, #9F0712)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-1/4" data-name="Vector">
        <div className="absolute inset-[-8.33%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.33333 9.33333">
            <path d={svgPaths.p30908200} id="Vector" stroke="var(--stroke-0, #9F0712)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
    </div>
...
function NotificationPill2() {
  return (
    <div className="relative rounded-[33554400px] shrink-0 size-[24px]" data-name="NotificationPill">
...
function Container46() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[14px] h-[60px] items-center left-[1068.61px] px-[26px] py-[18px] rounded-[33554400px] top-[24px] w-[258.391px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[#ffc9c9] border-solid inset-0 pointer-events-none rounded-[33554400px] shadow-[0px_10px_15px_0px_rgba(0,0,0,0.1),0px_4px_6px_0px_rgba(0,0,0,0.1)]" />
      <NotificationPill />
      <NotificationPill1 />
      <NotificationPill2 />
    </div>
...
export default function PostsTagsGagal() {
  return (
    <div className="bg-gradient-to-b from-[#f8fafc] relative size-full to-[#f1f5f9]" data-name="posts/tags/gagal">
      <Body />
      <DashboardLayout1 />
      <DashboardLayout2 />
      <Container46 />
