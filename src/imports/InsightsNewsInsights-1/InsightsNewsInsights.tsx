import svgPaths from "./svg-9icz2h1jbk";
import imgDropdown from "./fe145811d85e976b48c3eba6c8a19c3bb98997dc.png";
...
function Link1() {
  return (
    <div className="h-[46px] relative shrink-0 w-[128.813px]" data-name="Link">
      <div aria-hidden="true" className="absolute border-[#6366f1] border-b-2 border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start pb-[14px] pt-[12px] px-[24px] relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#6366f1] text-[14px] whitespace-nowrap">News Search</p>
      </div>
    </div>
  );
}
...
function Link2() {
  return (
    <div className="h-[46px] relative shrink-0 w-[130.766px]" data-name="Link">
      <div aria-hidden="true" className="absolute border-[#10151c] border-b-2 border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start pb-[14px] pt-[12px] px-[24px] relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#64748b] text-[14px] whitespace-nowrap">Social Trends</p>
      </div>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#64748b] text-[16px] top-[-2px] whitespace-nowrap">Riset artikel trending dari space konten kompetitor otomatis.</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_2_8027)" id="Icon">
          <path d="M12.5 15H8.33333" id="Vector" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M15 11.6667H8.33333" id="Vector_2" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p2e7cc000} id="Vector_3" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.pc16100} id="Vector_4" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
        <defs>
...
function Container4() {
  return (
    <div className="h-[27px] relative shrink-0 w-[164.281px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[27px] left-0 not-italic text-[#10151c] text-[18px] top-[-1px] whitespace-nowrap">News Search Engine</p>
      </div>
    </div>
  );
}

function NewsSearchPage1() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[40px] items-center left-[32px] top-[32px] w-[965px]" data-name="NewsSearchPage">
      <Container3 />
      <Container4 />
    </div>
  );
...
function NewsSearchPage2() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[32px] top-[96px] w-[965px]" data-name="NewsSearchPage">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative text-[#64748b] text-[14px]">Mencari artikel berita relevan dari seluruh web via Google News API.</p>
    </div>
  );
}
...
function Label() {
  return (
    <div className="absolute content-stretch flex h-[19px] items-start left-0 top-[3px] w-[75.125px]" data-name="Label">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#10151c] text-[14px] whitespace-nowrap">Topik Berita</p>
    </div>
  );
}
...
function TextInput() {
  return (
    <div className="absolute bg-[#f8fafc] h-[48px] left-0 rounded-[16px] top-[24px] w-[965px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip px-[16px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#64748b] text-[16px] whitespace-nowrap">Contoh: Harga Emas</p>
      </div>
...
function Label1() {
  return (
    <div className="absolute content-stretch flex h-[19px] items-start left-0 top-[3px] w-[97.547px]" data-name="Label">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#10151c] text-[14px] whitespace-nowrap">Rentang Waktu</p>
    </div>
  );
}
...
function Dropdown() {
  return (
    <div className="absolute h-[48px] left-0 pointer-events-none rounded-[16px] top-[24px] w-[639.328px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute inset-0 rounded-[16px]">
        ...
        <div className="absolute inset-0 overflow-hidden rounded-[16px]">
          <img alt="" className="absolute h-[41.67%] left-[2.29%] max-w-none top-[29.82%] w-[3.13%]" src={imgDropdown} />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-2 border-[#e2e8f0] border-solid inset-0 rounded-[16px]" />
    </div>
  );
}
...
function Icon1() {
  return (
    <div className="absolute left-[115.73px] size-[16px] top-[18px]" data-name="Icon">
...
function UiButton() {
  return (
    <div className="bg-[#1976d2] flex-[1_0_0] h-[52px] min-w-px relative rounded-[33554400px] shadow-[0px_10px_15px_0px_rgba(99,102,241,0.25),0px_4px_6px_0px_rgba(99,102,241,0.25)]" data-name="UIButton">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon1 />
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-[173.73px] not-italic text-[16px] text-center text-white top-[12px] whitespace-nowrap">Search</p>
      </div>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="absolute content-stretch flex h-[72px] items-end left-[651.33px] top-0 w-[313.656px]" data-name="Container">
      <UiButton />
    </div>
  );
}
...
function NewsSearchPage3() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[160px] items-start left-[32px] top-[140px] w-[965px]" data-name="NewsSearchPage">
      <Container5 />
      <Container6 />
    </div>
  );
...
function NewsSearchPage4() {
  return <div className="absolute border-[rgba(226,232,240,0.5)] border-solid border-t h-px left-[32px] top-[332px] w-[965px]" data-name="NewsSearchPage" />;
}
  ...
  return (
    <div className="relative shrink-0 size-[32px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="Icon">
          <path d={svgPaths.p27fd0e80} id="Vector" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.6" strokeWidth="2.66667" />
          <path d="M28 28L22.2667 22.2667" id="Vector_2" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.6" strokeWidth="2.66667" />
        </g>
      </svg>
    </div>
  );
...
function Heading2() {
  return (
    <div className="absolute h-[24px] left-0 top-[80px] w-[384px]" data-name="Heading 4">
      <p className="-translate-x-1/2 absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-[192.22px] not-italic text-[#10151c] text-[16px] text-center top-[-2px] whitespace-nowrap">Mulai Pencarian</p>
    </div>
  );
}
  ...
  return (
    <div className="absolute h-[40px] left-0 top-[112px] w-[384px]" data-name="Paragraph">
      <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[192px] not-italic text-[#64748b] text-[0px] text-center top-[-1px] w-[384px]">
        <span className="leading-[20px] text-[14px]">{`Masukkan topik berita dan klik tombol `}</span>
        <span className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] text-[#6366f1] text-[14px]">Search</span>
        <span className="leading-[20px] text-[14px]">{` untuk mencari artikel terbaru.`}</span>
      </p>
    </div>
  );
}
...
function NewsSearchPage5() {
  return (
    <div className="absolute content-stretch flex flex-col h-[252px] items-start left-[32px] pb-[2px] pt-[50px] px-[290.5px] rounded-[16px] top-[365px] w-[965px]" style={{ backgroundImage: "linear-gradient(165.365deg, rgba(241, 245, 249, 0.2) 0%, rgba(241, 245, 249, 0.3) 100%)" }} data-name="NewsSearchPage">
...
function Container2() {
  return (
    <div className="h-[649px] relative shrink-0 w-full" data-name="Container">
      <NewsSearchPage1 />
      <NewsSearchPage2 />
      <NewsSearchPage3 />
      <NewsSearchPage4 />
...
function UiCard() {
  return (
    <div className="bg-white h-[651px] relative rounded-[16px] shrink-0 w-full" data-name="UICard">
...
function NewsSearchPage() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] h-[739px] items-start relative shrink-0 w-full" data-name="NewsSearchPage">
      <Container1 />
      <UiCard />
    </div>
  );
...
function DashboardLayout() {
  return (
    <div className="h-[946px] relative shrink-0 w-full" style={{ backgroundImage: "linear-gradient(144.999deg, rgb(248, 250, 252) 0%, rgb(248, 250, 252) 50%, rgba(241, 245, 249, 0.3) 100%)" }} data-name="DashboardLayout">
...
function Text() {
  return <div className="absolute bg-[#00c950] left-[16px] opacity-66 rounded-[33554400px] size-[8px] top-[12px]" data-name="Text" />;
}
...
function Link5() {
  return (
    <div className="bg-[#6f7071] h-[36px] relative rounded-[12px] shrink-0 w-full" data-name="Link">
      <div className="content-stretch flex items-start pl-[32px] pr-[16px] py-[8px] relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-w-px not-italic relative text-[#f8fafc] text-[14px]">News Search</p>
      </div>
    </div>
  );
}
...
function Link6() {
  return (
    <div className="h-[36px] relative rounded-[12px] shrink-0 w-full" data-name="Link">
      <div className="content-stretch flex items-start pl-[32px] pr-[16px] py-[8px] relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative text-[14px] text-[rgba(248,250,252,0.6)]">Social Trends</p>
      </div>
    </div>
  );
}
...
function Link7() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[44px] items-center left-[16px] px-[16px] py-[12px] rounded-[16px] top-[286px] w-[208px]" data-name="Link">
      <Icon8 />
      <DashboardLayout4 />
    </div>
  );
...
function DashboardLayout2() {
  return (
    <div className="absolute bg-[#0b3258] content-stretch flex flex-col h-[946px] items-start left-0 pr-px top-0 w-[256px]" data-name="DashboardLayout">
...
export default function InsightsNewsInsights() {
  return (
    <div className="bg-gradient-to-b from-[#f8fafc] relative size-full to-[#f1f5f9]" data-name="insights/news insights">
      <Body />
      <DashboardLayout1 />
      <DashboardLayout2 />
    </div>
