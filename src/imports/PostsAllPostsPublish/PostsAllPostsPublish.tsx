import svgPaths from "./svg-cqjjd8kc8l";
...
function Button() {
  return (
    <div className="h-[36px] relative rounded-[33554400px] shrink-0 w-[82.938px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start px-[20px] py-[8px] relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#64748b] text-[14px] text-center whitespace-nowrap">Semua</p>
      </div>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="bg-gradient-to-r flex-[1_0_0] from-[#6366f1] h-[36px] min-w-px relative rounded-[33554400px] shadow-[0px_10px_15px_0px_rgba(99,102,241,0.25),0px_4px_6px_0px_rgba(99,102,241,0.25)] to-[rgba(99,102,241,0.9)]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start px-[20px] py-[8px] relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Published</p>
      </div>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="content-stretch flex h-[19px] items-start relative shrink-0 w-full" data-name="Text">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[20px] not-italic relative shrink-0 text-[#10151c] text-[14px] whitespace-nowrap">3 artikel</p>
    </div>
  );
}
...
function TableRow3() {
  return (
    <div className="absolute bg-white h-[74.5px] left-0 top-[150px] w-[963px]" data-name="Table Row">
      <Container19 />
      <Text9 />
      <TableCell2 />
      <Container21 />
...
function TableBody() {
  return (
    <div className="absolute h-[224.5px] left-0 top-[52.5px] w-[963px]" data-name="Table Body">
      <TableRow1 />
      <TableRow2 />
      <TableRow3 />
    </div>
...
function Container10() {
  return (
    <div className="h-[277px] overflow-clip relative shrink-0 w-full" data-name="Container">
      <TableRow />
      <TableBody />
    </div>
  );
...
function UiTable() {
  return (
    <div className="bg-white h-[279px] relative rounded-[16px] shrink-0 w-full" data-name="UITable">
...
function Container6() {
  return (
    <div className="h-[436px] relative shrink-0 w-full" data-name="Container">
...
function UiCard1() {
  return (
    <div className="bg-white h-[438px] relative rounded-[16px] shrink-0 w-full" data-name="UICard">
      <div aria-hidden="true" className="absolute border border-[rgba(226,232,240,0.5)] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)]" />
      <div className="content-stretch flex flex-col items-start p-px relative size-full">
        <Container6 />
      </div>
...
function DashboardLayout() {
  return (
    <div className="h-[801px] relative shrink-0 w-full" style={{ backgroundImage: "linear-gradient(149.337deg, rgb(248, 250, 252) 0%, rgb(248, 250, 252) 50%, rgba(241, 245, 249, 0.3) 100%)" }} data-name="DashboardLayout">
...
function Link2() {
  return (
    <div className="bg-[#500] h-[36px] relative rounded-[12px] shrink-0 w-full" data-name="Link">
...
function DashboardLayout2() {
  return (
    <div className="absolute bg-[#0b3258] content-stretch flex flex-col h-[801px] items-start left-0 pr-px top-0" data-name="DashboardLayout">
...
export default function PostsAllPostsPublish() {
  return (
    <div className="bg-gradient-to-b from-[#f8fafc] relative size-full to-[#f1f5f9]" data-name="posts/all posts/publish">
      <Body />
      <DashboardLayout1 />
      <DashboardLayout2 />
    </div>
