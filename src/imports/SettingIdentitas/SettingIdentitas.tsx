import svgPaths from "./svg-nhr1uew3qp";
...
function Navigation() {
  return (
    <div className="absolute h-[687px] left-[3px] top-[104px] w-[240px]" data-name="Navigation">
      <Link />
      <Button8 />
      <Button9 />
      <Button10 />
...
export default function SettingIdentitas() {
  return (
    <div className="bg-white relative size-full" data-name="setting/identitas">
      <App />
      <TopBar />
      <Sidebar />
    </div>
