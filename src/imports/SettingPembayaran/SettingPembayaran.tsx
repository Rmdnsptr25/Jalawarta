import svgPaths from "./svg-q6i56q37rx";
...
function Container12() {
  return (
    <div className="bg-[#f8fafc] flex-[1_0_0] min-h-px relative rounded-[12px] w-[965px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-dashed inset-0 pointer-events-none rounded-[12px]" />
      <div className="flex flex-row items-center justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center pl-[262.469px] pr-[262.484px] py-[33px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal h-[22px] leading-[22px] not-italic relative shrink-0 text-[#94a3b8] text-[14px] w-[440px]">{`Belum ada rekening. Klik "Tambah Rekening" untuk menambahkan.`}</p>
        </div>
      </div>
    </div>
  );
...
function Container10() {
  return (
    <div className="h-[124px] relative shrink-0 w-[965px]" data-name="Container">
...
function Container5() {
  return (
    <div className="h-[540px] relative shrink-0 w-full" data-name="Container">
...
function Container() {
  return (
    <div className="h-[878px] relative shrink-0 w-full" data-name="Container">
...
function App() {
  return (
    <div className="absolute content-stretch flex flex-col h-[878px] items-start left-0 pl-[256px] top-[73px] w-[1351px]" style={{ backgroundImage: "linear-gradient(rgb(248, 250, 252) 0%, rgb(246, 248, 251) 33.333%, rgb(243, 247, 250) 66.667%, rgb(241, 245, 249) 100%)" }} data-name="App">
      <Container />
    </div>
  );
}
...
function Container26() {
  return (
    <div className="absolute content-stretch flex flex-col h-[97px] items-start left-0 pt-[17px] px-[16px] top-[854px] w-[255px]" data-name="Container">
...
function Sidebar() {
  return (
    <div className="absolute bg-[#0b3258] h-[951px] left-0 overflow-clip top-0 w-[256px]" data-name="Sidebar">
      <Navigation />
      <Container26 />
      <Container30 />
      <Container31 />
...
export default function SettingPembayaran() {
  return (
    <div className="bg-white relative size-full" data-name="setting/pembayaran">
      <App />
      <TopBar />
      <Sidebar />
    </div>
