import svgPaths from "./svg-pssdy08ya2";
...
function Text7() {
  return <div className="absolute bg-[#00c950] left-[16px] opacity-96 rounded-[33554400px] size-[8px] top-[12px]" data-name="Text" />;
}
...
function Button25() {
  return (
    <div className="h-[44px] relative shrink-0 w-[103.516px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start px-[16px] py-[12px] relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#64748b] text-[14px] text-center whitespace-nowrap">Upload File</p>
      </div>
    </div>
  );
}
...
function Button26() {
  return (
    <div className="h-[46px] relative shrink-0 w-[112.641px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#6366f1] border-b-2 border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start pb-[14px] pt-[12px] px-[16px] relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#6366f1] text-[14px] text-center whitespace-nowrap">Galeri Media</p>
      </div>
    </div>
  );
}
...
function TextInput4() {
  return (
    <div className="absolute bg-[#f8fafc] h-[48px] left-0 rounded-[16px] top-0 w-[705px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip pl-[44px] pr-[16px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-[rgba(100,116,139,0.5)] whitespace-nowrap">Cari file, alt-text, atau caption...</p>
      </div>
      <div aria-hidden="true" className="absolute border-2 border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[16px]" />
    </div>
  );
...
function Icon32() {
  return (
    <div className="absolute left-[320.5px] size-[64px] top-[48px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 64 64">
        <g id="Icon">
          <path d={svgPaths.p30945c70} id="Vector" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.4" strokeWidth="5.33333" />
          <path d={svgPaths.p1ad2500} id="Vector_2" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.4" strokeWidth="5.33333" />
          <path d={svgPaths.p3bb88000} id="Vector_3" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.4" strokeWidth="5.33333" />
        </g>
      </svg>
    </div>
  );
...
function Paragraph6() {
  return (
    <div className="absolute h-[24px] left-0 top-[128px] w-[705px]" data-name="Paragraph">
      <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[352.22px] not-italic text-[#64748b] text-[16px] text-center top-[-2px] whitespace-nowrap">Belum ada media tersimpan.</p>
    </div>
  );
}
...
function Button27() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[247.94px] top-[163px] w-[209.109px]" data-name="Button">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#6366f1] text-[14px] text-center whitespace-nowrap">Upload gambar pertama Anda →</p>
    </div>
  );
}
...
function Container68() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] h-[304px] items-start relative shrink-0 w-full" data-name="Container">
      <Container69 />
      <Container70 />
    </div>
  );
...
function Container67() {
  return (
    <div className="flex-[335.188_0_0] min-h-px relative w-[768px]" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
...
function Container64() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[467.188px] items-start left-[292px] rounded-[16px] shadow-[0px_25px_50px_0px_rgba(0,0,0,0.25)] top-[746px] w-[768px]" data-name="Container">
      <Container65 />
      <Container66 />
      <Container67 />
    </div>
...
function CreatePagePage() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.6)] h-[1959px] left-0 top-0 w-[1351px]" data-name="CreatePagePage">
      <Container64 />
    </div>
  );
}

export default function MediaGaleriMedia() {
  return (
    <div className="bg-gradient-to-b from-[#f8fafc] relative size-full to-[#f1f5f9]" data-name="media/galeri media">
      <Body />
      <DashboardLayout1 />
      <DashboardLayout2 />
      <CreatePagePage />
