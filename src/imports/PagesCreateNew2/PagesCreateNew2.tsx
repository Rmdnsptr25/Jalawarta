import svgPaths from "./svg-clyuvhd8og";
  ...
  return (
    <div className="h-[16px] overflow-clip relative shrink-0 w-full" data-name="Icon">
      <div className="absolute inset-[8.33%_20.83%]" data-name="Vector">
        <div className="absolute inset-[-5%_-7.14%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.6667 14.6667">
            <path d={svgPaths.p3d24c340} id="Vector" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-1/4 left-1/2 right-[49.96%] top-3/4" data-name="Vector">
        <div className="absolute inset-[-0.67px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1.34 1.33333">
            <path d="M0.666667 0.666667H0.673334" id="Vector" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
    </div>
      ...
      <div className="absolute inset-[12.5%_8.33%_29.17%_8.33%]" data-name="Vector">
        <div className="absolute inset-[-7.14%_-5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.6667 10.6667">
            <path d={svgPaths.pb5eef70} id="Vector" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[87.5%_33.33%_12.5%_33.33%]" data-name="Vector">
        <div className="absolute inset-[-0.67px_-12.5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6.66667 1.33333">
            <path d="M0.666667 0.666667H6" id="Vector" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-[12.5%] left-1/2 right-1/2 top-[70.83%]" data-name="Vector">
        <div className="absolute inset-[-25%_-0.67px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1.33333 4">
            <path d="M0.666667 0.666667V3.33333" id="Vector" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
    </div>
...
function Button17() {
  return (
    <div className="bg-[rgba(99,102,241,0.1)] flex-[1_0_0] h-[28px] min-w-px relative rounded-[4px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[6px] px-[6px] relative size-full">
        <Icon13 />
      </div>
    </div>
...
function Icon14() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_2_8003)" id="Icon">
          ...
          <path d={svgPaths.p14d10c00} id="Vector_2" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M1.33333 8H14.6667" id="Vector_3" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
        <defs>
          <clipPath id="clip0_2_8003">
...
function Container26() {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[16px] min-w-px not-italic relative text-[#64748b] text-[12px]">jalawarta.com</p>
    </div>
  );
}
...
function Container27() {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[12px] text-[rgba(100,116,139,0.7)] whitespace-nowrap">post › permalink</p>
    </div>
  );
}
...
function Container25() {
  return (
    <div className="h-[32px] relative shrink-0 w-[86.125px]" data-name="Container">
...
function Container24() {
  return (
    <div className="absolute content-stretch flex gap-[8px] h-[32px] items-center left-[17px] top-[17px] w-[579.328px]" data-name="Container">
      <Icon14 />
      <Container25 />
    </div>
  );
...
function Heading3() {
  return (
    <div className="absolute h-[24px] left-[17px] top-[57px] w-[579.328px]" data-name="Heading 4">
...
function Paragraph1() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[17px] overflow-clip top-[85px] w-[579.328px]" data-name="Paragraph">
...
function Container23() {
  return (
    <div className="bg-[rgba(241,245,249,0.3)] h-[122px] relative rounded-[16px] shrink-0 w-full" data-name="Container">
...
function Container20() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[158px] items-start relative shrink-0 w-full" data-name="Container">
      <Container21 />
      <Container23 />
    </div>
  );
...
function Container17() {
  return (
    <div className="h-[772px] relative shrink-0 w-full" data-name="Container">
...
function Container15() {
  return (
    <div className="bg-white h-[829px] relative rounded-[16px] shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[rgba(226,232,240,0.5)] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)]" />
...
function Container2() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[1772px] items-start left-0 top-0 w-[679.328px]" data-name="Container">
      <Container3 />
      <Container7 />
      <Container15 />
    </div>
...
function Container43() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[1772px] items-start left-[703.33px] top-0 w-[327.672px]" data-name="Container">
      <Container44 />
      <Container46 />
    </div>
  );
...
function Container1() {
  return (
    <div className="h-[1772px] relative shrink-0 w-full" data-name="Container">
      <Container2 />
      <Container43 />
    </div>
  );
...
function DashboardLayout() {
  return (
    <div className="h-[1969px] relative shrink-0 w-full" style={{ backgroundImage: "linear-gradient(124.455deg, rgb(248, 250, 252) 0%, rgb(248, 250, 252) 50%, rgba(241, 245, 249, 0.3) 100%)" }} data-name="DashboardLayout">
...
function Text7() {
  return <div className="absolute bg-[#00c950] left-[16px] opacity-57 rounded-[33554400px] size-[8px] top-[12px]" data-name="Text" />;
}
...
function DashboardLayout2() {
  return (
    <div className="absolute bg-[#0b3258] content-stretch flex flex-col h-[1969px] items-start left-0 pr-px top-0 w-[256px]" data-name="DashboardLayout">
...
export default function PagesCreateNew() {
  return (
    <div className="bg-gradient-to-b from-[#f8fafc] relative size-full to-[#f1f5f9]" data-name="pages create new 2">
      <Body />
      <DashboardLayout1 />
      <DashboardLayout2 />
    </div>
