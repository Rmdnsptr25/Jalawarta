import svgPaths from "./svg-48tno84did";
  ...
  return (
    <div className="absolute left-[16px] size-[16px] top-[14px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_2_8067)" id="Icon">
          <path d={svgPaths.p36f21e80} id="Vector" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p2a594880} id="Vector_2" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p20b4ecc0} id="Vector_3" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M1.33333 4.66667H14.6667" id="Vector_4" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p4cbcae0} id="Vector_5" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
        <defs>
          <clipPath id="clip0_2_8067">
...
function Button() {
  return (
    <div className="h-[46px] relative rounded-tl-[8px] rounded-tr-[8px] shrink-0 w-[114.5px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon />
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[69.5px] not-italic text-[#6366f1] text-[14px] text-center top-[12px] whitespace-nowrap">Identitas</p>
      </div>
    </div>
  );
}
...
function Icon3() {
  return (
    <div className="absolute left-[16px] size-[16px] top-[15px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p35993080} id="Vector" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M1.33333 6.66667H14.6667" id="Vector_2" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Button3() {
  return (
    <div className="h-[46px] relative rounded-tl-[8px] rounded-tr-[8px] shrink-0 w-[139.219px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon3 />
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[82px] not-italic text-[#64748b] text-[14px] text-center top-[13px] whitespace-nowrap">Pembayaran</p>
      </div>
    </div>
  );
}
...
function Label() {
  return (
    <div className="h-[20px] relative shrink-0 w-[470.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">NAMA SITUS</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[470.5px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[16px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Demo Berita</p>
      </div>
...
function Label1() {
  return (
    <div className="h-[20px] relative shrink-0 w-[470.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">SLOGAN / TAGLINE</p>
      </div>
    </div>
  );
}
...
function TextInput1() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[470.5px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[16px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Berita terpercaya setiap hari</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Label2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[965px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">DESKRIPSI / TENTANG SITUS</p>
      </div>
    </div>
  );
}
...
function TextArea() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[965px]" data-name="Text Area">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start px-[16px] py-[12px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[22px] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Jelaskan tentang portal berita Anda...</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Label3() {
  return (
    <div className="h-[20px] relative shrink-0 w-[470.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">LOGO SITUS</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d={svgPaths.p8095140} id="Vector" stroke="var(--stroke-0, #94A3B8)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p34a027c0} id="Vector_2" stroke="var(--stroke-0, #94A3B8)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p17181500} id="Vector_3" stroke="var(--stroke-0, #94A3B8)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M2 7H22" id="Vector_4" stroke="var(--stroke-0, #94A3B8)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p1827a4c0} id="Vector_5" stroke="var(--stroke-0, #94A3B8)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Container13() {
  return (
    <div className="bg-[#f8fafc] relative rounded-[8px] shrink-0 size-[64px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[#e2e8f0] border-dashed inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[20px] py-[2px] relative size-full">
        <Icon5 />
      </div>
    </div>
  );
...
function Button5() {
  return (
    <div className="bg-white h-[36px] relative rounded-[8px] shrink-0 w-[118.484px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[59.5px] not-italic text-[#64748b] text-[14px] text-center top-[8px] whitespace-nowrap">Pilih Gambar</p>
      </div>
    </div>
  );
}
...
function Container12() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-[470.5px]" data-name="Container">
...
function Container11() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[92px] items-start left-0 top-0 w-[470.5px]" data-name="Container">
      <Label3 />
      <Container12 />
    </div>
  );
...
function Label4() {
  return (
    <div className="h-[20px] relative shrink-0 w-[470.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">FAVICON</p>
      </div>
    </div>
  );
}
...
function Text() {
  return (
    <div className="h-[20px] relative shrink-0 w-[21.344px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[20px] left-0 text-[#94a3b8] text-[12px] top-0 whitespace-nowrap">ICO</p>
      </div>
    </div>
  );
}
...
function Container16() {
  return (
    <div className="bg-[#f8fafc] relative rounded-[8px] shrink-0 size-[64px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[#e2e8f0] border-dashed inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[21.328px] py-[2px] relative size-full">
        <Text />
      </div>
    </div>
  );
...
function Button6() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[120.563px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[60.53px] not-italic text-[#64748b] text-[14px] text-center top-[8px] whitespace-nowrap">Pilih Gambar</p>
      </div>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="h-[18px] relative shrink-0 w-[120.563px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#94a3b8] text-[11px] top-0 whitespace-nowrap">Disarankan 512×512 px</p>
      </div>
    </div>
  );
}
...
function Container17() {
  return (
    <div className="h-[58px] relative shrink-0 w-[120.563px]" data-name="Container">
...
function Container14() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[92px] items-start left-[494.5px] top-0 w-[470.5px]" data-name="Container">
      <Label4 />
      <Container15 />
    </div>
  );
...
function Container10() {
  return (
    <div className="h-[92px] relative shrink-0 w-[965px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container11 />
        <Container14 />
      </div>
...
function Label5() {
  return (
    <div className="h-[20px] relative shrink-0 w-[965px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">WARNA UTAMA</p>
      </div>
    </div>
  );
}
...
function ColorPicker() {
  return (
    <div className="bg-white relative rounded-[8px] shrink-0 size-[44px]" data-name="Color Picker">
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
}
...
function TextInput2() {
  return (
    <div className="bg-white h-[44px] relative rounded-[8px] shrink-0 w-[200px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[16px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">#2B62E2</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Container5() {
  return (
    <div className="h-[514px] relative shrink-0 w-full" data-name="Container">
...
function Paragraph1() {
  return (
    <div className="flex-[1_0_0] h-[20px] min-w-px relative" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#10b981] text-[14px] top-0 whitespace-nowrap">Pengaturan berhasil disimpan.</p>
      </div>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="absolute content-stretch flex gap-[8px] h-[20px] items-center left-0 top-0 w-[230.406px]" data-name="Container">
      <Container22 />
      <Paragraph1 />
    </div>
  );
...
function Container() {
  return (
    <div className="h-[852px] relative shrink-0 w-full" data-name="Container">
...
function App() {
  return (
    <div className="absolute content-stretch flex flex-col h-[852px] items-start left-0 pl-[256px] top-[73px] w-[1351px]" style={{ backgroundImage: "linear-gradient(rgb(248, 250, 252) 0%, rgb(246, 248, 251) 33.333%, rgb(243, 247, 250) 66.667%, rgb(241, 245, 249) 100%)" }} data-name="App">
      <Container />
    </div>
  );
}
...
function Navigation() {
  return (
    <div className="absolute h-[687px] left-0 top-[101px] w-[240px]" data-name="Navigation">
      <Link />
      <Button8 />
      <Button9 />
      <Button10 />
...
function Container34() {
  return (
    <div className="absolute content-stretch flex flex-col h-[97px] items-start left-px pt-[17px] px-[16px] top-[828px] w-[255px]" data-name="Container">
...
function Sidebar() {
  return (
    <div className="absolute bg-[#0b3258] h-[925px] left-0 overflow-clip top-0 w-[256px]" data-name="Sidebar">
      <Navigation />
      <Container31 />
      <Container32 />
      <Container33 />
...
export default function SettingIdentitasSimpanPerubahan() {
  return (
    <div className="bg-white relative size-full" data-name="setting/identitas/simpan perubahan">
      <App />
      <TopBar />
      <Sidebar />
    </div>
