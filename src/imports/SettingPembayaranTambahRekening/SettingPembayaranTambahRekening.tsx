import svgPaths from "./svg-mzeqhdzxhn";

function Heading() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-[619.938px]" data-name="Heading 1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[40px] left-0 not-italic text-[#10151c] text-[36px] top-0 whitespace-nowrap">Pengaturan Situs</p>
      </div>
    </div>
  );
}
...
function Container1() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[76px] items-start relative shrink-0 w-[619.938px]" data-name="Container">
      <Heading />
      <p className="font-['Inter:Regular',sans-serif] font-normal h-[28px] leading-[28px] not-italic relative shrink-0 text-[#64748b] text-[18px] w-[620px]">Kelola informasi umum, preferensi, dan konfigurasi dasar situs web Anda.</p>
    </div>
  );
}
...
function Icon() {
  return (
    <div className="absolute left-[16px] size-[16px] top-[15px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_2_8368)" id="Icon">
          <path d={svgPaths.p36f21e80} id="Vector" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p2a594880} id="Vector_2" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p20b4ecc0} id="Vector_3" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M1.33333 4.66667H14.6667" id="Vector_4" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p4cbcae0} id="Vector_5" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
        <defs>
...
function Button() {
  return (
    <div className="h-[46px] relative rounded-tl-[8px] rounded-tr-[8px] shrink-0 w-[114.5px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon />
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[69.5px] not-italic text-[#64748b] text-[14px] text-center top-[13px] whitespace-nowrap">Identitas</p>
      </div>
    </div>
  );
}
...
function Icon1() {
  return (
    <div className="absolute left-[16px] size-[16px] top-[15px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_2_7846)" id="Icon">
          <path d={svgPaths.p2a44c680} id="Vector" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
        <defs>
          <clipPath id="clip0_2_7846">
            <rect fill="white" height="16" width="16" />
          </clipPath>
        </defs>
      </svg>
...
function Button1() {
  return (
    <div className="h-[46px] relative rounded-tl-[8px] rounded-tr-[8px] shrink-0 w-[102.516px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon1 />
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[63.5px] not-italic text-[#64748b] text-[14px] text-center top-[13px] whitespace-nowrap">Kontak</p>
      </div>
    </div>
  );
}
...
function Icon2() {
  return (
    <div className="absolute left-[16px] size-[16px] top-[15px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p185fb780} id="Vector" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p30ca5e80} id="Vector_2" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.pac25b80} id="Vector_3" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M5.72667 9.00667L10.28 11.66" id="Vector_4" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p533300} id="Vector_5" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Button2() {
  return (
    <div className="h-[46px] relative rounded-tl-[8px] rounded-tr-[8px] shrink-0 w-[140.609px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon2 />
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[82.5px] not-italic text-[#64748b] text-[14px] text-center top-[13px] whitespace-nowrap">Sosial Media</p>
      </div>
    </div>
  );
}
...
function Icon3() {
  return (
    <div className="absolute left-[16px] size-[16px] top-[14px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p35993080} id="Vector" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M1.33333 6.66667H14.6667" id="Vector_2" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Button3() {
  return (
    <div className="h-[46px] relative rounded-tl-[8px] rounded-tr-[8px] shrink-0 w-[139.219px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#6366f1] border-b-2 border-solid inset-0 pointer-events-none rounded-tl-[8px] rounded-tr-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon3 />
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[82px] not-italic text-[#6366f1] text-[14px] text-center top-[12px] whitespace-nowrap">Pembayaran</p>
      </div>
    </div>
  );
}
...
function Icon4() {
  return (
    <div className="absolute left-[16px] size-[16px] top-[15px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d="M13.3333 4.66667H7.33333" id="Vector" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M9.33333 11.3333H3.33333" id="Vector_2" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p2badb400} id="Vector_3" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p79fe00} id="Vector_4" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Button4() {
  return (
    <div className="h-[46px] relative rounded-tl-[8px] rounded-tr-[8px] shrink-0 w-[99.375px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon4 />
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[62px] not-italic text-[#64748b] text-[14px] text-center top-[13px] whitespace-nowrap">Teknis</p>
      </div>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="bg-[rgba(59,130,246,0.05)] h-[56px] relative rounded-[12px] shrink-0 w-[965px]" data-name="Container">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-px pt-[17px] px-[17px] relative size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal h-[22px] leading-[22px] not-italic relative shrink-0 text-[#64748b] text-[13px] w-[779px]">Info pembayaran ini ditampilkan di frontend publik (halaman donasi, footer). Bukan untuk pembayaran subscription ke platform.</p>
      </div>
    </div>
  );
}
...
function Label() {
  return (
    <div className="h-[20px] relative shrink-0 w-[470.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">NAMA BADAN USAHA</p>
      </div>
    </div>
  );
}
...
function TextInput() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[470.5px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[16px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">PT. Nama Berita Indonesia</p>
      </div>
...
function Container8() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[72px] items-start left-0 top-0 w-[470.5px]" data-name="Container">
      <Label />
      <TextInput />
    </div>
  );
...
function Label1() {
  return (
    <div className="h-[20px] relative shrink-0 w-[470.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">NPWP (optional)</p>
      </div>
    </div>
  );
}
...
function TextInput1() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[470.5px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[16px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">00.000.000.0-000.000</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Container9() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[72px] items-start left-[494.5px] top-0 w-[470.5px]" data-name="Container">
      <Label1 />
      <TextInput1 />
    </div>
  );
...
function Container7() {
  return (
    <div className="h-[72px] relative shrink-0 w-[965px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container8 />
        <Container9 />
      </div>
...
function Label2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[104.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">REKENING BANK</p>
      </div>
    </div>
  );
}
...
function Button5() {
  return (
    <div className="h-[20px] relative shrink-0 w-[132.016px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#6366f1] text-[14px] text-center whitespace-nowrap">+ Tambah Rekening</p>
      </div>
    </div>
  );
}
...
function Container11() {
  return (
    <div className="h-[20px] relative shrink-0 w-[965px]" data-name="Container">
...
function Text() {
  return (
    <div className="h-[20px] relative shrink-0 w-[74.703px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[20px] left-0 text-[#10151c] text-[14px] top-0 whitespace-nowrap">Rekening 1</p>
      </div>
    </div>
  );
}
...
function Icon5() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d="M2 4H14" id="Vector" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p64eb800} id="Vector_2" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p56ef700} id="Vector_3" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M6.66667 7.33333V11.3333" id="Vector_4" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M9.33333 7.33333V11.3333" id="Vector_5" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Label3() {
  return (
    <div className="h-[18px] relative shrink-0 w-[453.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#64748b] text-[11px] top-0 tracking-[0.55px] uppercase whitespace-nowrap">NAMA BANK</p>
      </div>
    </div>
  );
}
...
function TextInput2() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[6px] w-[453.5px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[12px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[13px] whitespace-nowrap">BCA, Mandiri, BNI...</p>
      </div>
...
function Container15() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[6px] h-[64px] items-start left-0 top-0 w-[453.5px]" data-name="Container">
      <Label3 />
      <TextInput2 />
    </div>
  );
...
function Label4() {
  return (
    <div className="h-[18px] relative shrink-0 w-[453.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#64748b] text-[11px] top-0 tracking-[0.55px] uppercase whitespace-nowrap">LABEL (optional)</p>
      </div>
    </div>
  );
}
...
function TextInput3() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[6px] w-[453.5px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[12px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[13px] whitespace-nowrap">Rekening Donasi</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
  );
...
function Container16() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[6px] h-[64px] items-start left-[469.5px] top-0 w-[453.5px]" data-name="Container">
      <Label4 />
      <TextInput3 />
    </div>
  );
...
function Label5() {
  return (
    <div className="h-[18px] relative shrink-0 w-[453.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#64748b] text-[11px] top-0 tracking-[0.55px] uppercase whitespace-nowrap">NO. REKENING</p>
      </div>
    </div>
  );
}
...
function TextInput4() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[6px] w-[453.5px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[12px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[13px] whitespace-nowrap">1234567890</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
  );
...
function Container17() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[6px] h-[64px] items-start left-0 top-[80px] w-[453.5px]" data-name="Container">
      <Label5 />
      <TextInput4 />
    </div>
  );
...
function Label6() {
  return (
    <div className="h-[18px] relative shrink-0 w-[453.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#64748b] text-[11px] top-0 tracking-[0.55px] uppercase whitespace-nowrap">ATAS NAMA</p>
      </div>
    </div>
  );
}
...
function TextInput5() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[6px] w-[453.5px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[12px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[13px] whitespace-nowrap">Nama Pemilik</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[6px]" />
    </div>
  );
...
function Container18() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[6px] h-[64px] items-start left-[469.5px] top-[80px] w-[453.5px]" data-name="Container">
      <Label6 />
      <TextInput5 />
    </div>
  );
...
function Container12() {
  return (
    <div className="bg-[#f8fafc] flex-[1_0_0] min-h-px relative rounded-[12px] w-[965px]" data-name="Container">
...
function Container10() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-[965px]" data-name="Container">
...
function Label7() {
  return (
    <div className="h-[20px] relative shrink-0 w-[965px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">QRIS TENANT</p>
      </div>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="h-[20px] relative shrink-0 w-[34.234px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[20px] left-0 text-[#94a3b8] text-[14px] top-0 whitespace-nowrap">QRIS</p>
      </div>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="bg-[#f8fafc] relative rounded-[8px] shrink-0 size-[120px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[#e2e8f0] border-dashed inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center pl-[42.875px] pr-[42.891px] py-[2px] relative size-full">
        <Text1 />
      </div>
    </div>
  );
...
function Icon6() {
  return (
    <div className="absolute left-[17px] size-[16px] top-[10px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p23ad1400} id="Vector" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p26e09a00} id="Vector_2" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M8 2V10" id="Vector_3" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Button7() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[208.781px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon6 />
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[111.5px] not-italic text-[#64748b] text-[14px] text-center top-[8px] whitespace-nowrap">Upload Gambar QRIS</p>
      </div>
    </div>
  );
}
...
function Text2() {
  return (
    <div className="h-[18px] relative shrink-0 w-[208.781px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#94a3b8] text-[11px] top-0 whitespace-nowrap">Format PNG/JPG, latar putih disarankan.</p>
      </div>
    </div>
  );
}
...
function Container22() {
  return (
    <div className="h-[58px] relative shrink-0 w-[208.781px]" data-name="Container">
...
function Container19() {
  return (
    <div className="h-[152px] relative shrink-0 w-[965px]" data-name="Container">
...
function Paragraph() {
  return (
    <div className="h-[20px] relative shrink-0 w-[253.266px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#64748b] text-[14px] top-0 whitespace-nowrap">Pastikan menyimpan perubahan Anda.</p>
      </div>
    </div>
  );
}
...
function Button8() {
  return (
    <div className="bg-[#1976d2] h-[44px] relative rounded-[12px] shadow-[0px_4px_12px_0px_rgba(99,102,241,0.3)] shrink-0 w-[214.25px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Arimo:Bold',sans-serif] font-bold leading-[20px] left-[107.5px] text-[16px] text-center text-white top-[12px] whitespace-nowrap">Simpan Pengaturan</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[93px] relative shrink-0 w-full" data-name="Container">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pb-[24px] pt-[25px] px-[32px] relative size-full">
          <Paragraph />
          <Button8 />
        </div>
      </div>
...
function Container() {
  return (
    <div className="h-[1020px] relative shrink-0 w-full" data-name="Container">
...
function App() {
  return (
    <div className="absolute content-stretch flex flex-col h-[1020px] items-start left-0 pl-[256px] top-[73px] w-[1351px]" style={{ backgroundImage: "linear-gradient(rgb(248, 250, 252) 0%, rgb(246, 248, 251) 33.333%, rgb(243, 247, 250) 66.667%, rgb(241, 245, 249) 100%)" }} data-name="App">
      <Container />
    </div>
  );
}
...
function Sidebar12() {
  return (
    <div className="h-[20px] relative shrink-0 w-[55.641px]" data-name="Sidebar">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[14px] text-white top-0 whitespace-nowrap">Settings</p>
      </div>
    </div>
  );
}
...
function Link5() {
  return (
    <div className="absolute bg-[#1976d2] content-stretch flex gap-[12.234px] h-[44px] items-center left-0 px-[16px] py-[12px] rounded-[16px] top-[57px] w-[208px]" data-name="Link">
      <Sidebar11 />
      <Sidebar12 />
    </div>
  );
...
function Navigation() {
  return (
    <div className="absolute h-[393px] left-0 top-[101px] w-[240px]" data-name="Navigation">
      <Link />
      <Button9 />
      <Button10 />
      <Button11 />
...
function Container35() {
  return (
    <div className="absolute h-[97px] left-px top-[828px] w-[255px]" data-name="Container">
...
function Container36() {
  return (
    <div className="absolute bg-[rgba(51,65,85,0.5)] content-stretch flex gap-[12px] h-[64px] items-center left-[17px] p-[12px] rounded-[16px] top-[1011px] w-[223px]" data-name="Container">
      <Container37 />
      <Container38 />
      <Button12 />
    </div>
...
function Sidebar() {
  return (
    <div className="absolute bg-[#0b3258] h-[1093px] left-0 overflow-clip top-0 w-[256px]" data-name="Sidebar">
      <Navigation />
      <Container32 />
      <Container33 />
      <Container34 />
...
export default function SettingPembayaranTambahRekening() {
  return (
    <div className="bg-white relative size-full" data-name="setting/pembayaran/tambah rekening">
      <App />
      <TopBar />
      <Sidebar />
    </div>
