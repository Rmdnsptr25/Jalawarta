import svgPaths from "./svg-8rmyd5s6xg";
...
function Icon2() {
  return (
    <div className="absolute left-[16px] size-[16px] top-[14px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p185fb780} id="Vector" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p30ca5e80} id="Vector_2" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.pac25b80} id="Vector_3" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M5.72667 9.00667L10.28 11.66" id="Vector_4" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p533300} id="Vector_5" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Button2() {
  return (
    <div className="h-[46px] relative rounded-tl-[8px] rounded-tr-[8px] shrink-0 w-[140.609px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon2 />
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[82.5px] not-italic text-[#6366f1] text-[14px] text-center top-[12px] whitespace-nowrap">Sosial Media</p>
      </div>
    </div>
  );
}
...
function Label() {
  return (
    <div className="h-[20px] relative shrink-0 w-[470.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">INSTAGRAM</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[470.5px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[16px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">@namaberita</p>
      </div>
...
function Label1() {
  return (
    <div className="h-[20px] relative shrink-0 w-[470.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">X (TWITTER)</p>
      </div>
    </div>
  );
}
...
function Label2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[470.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">FACEBOOK</p>
      </div>
    </div>
  );
}
...
function TextInput2() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[470.5px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[16px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">{`https://facebook.com/namaberita`}</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Label3() {
  return (
    <div className="h-[20px] relative shrink-0 w-[470.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">YOUTUBE</p>
      </div>
    </div>
  );
}
...
function TextInput3() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[470.5px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[16px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">{`https://youtube.com/@namaberita`}</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Label4() {
  return (
    <div className="h-[20px] relative shrink-0 w-[470.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">TIKTOK</p>
      </div>
    </div>
  );
}
...
function Label5() {
  return (
    <div className="h-[20px] relative shrink-0 w-[470.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">LINKEDIN</p>
      </div>
    </div>
  );
}
...
function TextInput5() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[470.5px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[16px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">{`https://linkedin.com/company/namaberita`}</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Container5() {
  return (
    <div className="h-[328px] relative shrink-0 w-full" data-name="Container">
...
function Container() {
  return (
    <div className="h-[666px] relative shrink-0 w-full" data-name="Container">
...
function App() {
  return (
    <div className="absolute content-stretch flex flex-col h-[666px] items-start left-0 pl-[256px] top-[73px] w-[1351px]" style={{ backgroundImage: "linear-gradient(rgb(248, 250, 252) 0%, rgb(246, 248, 251) 33.333%, rgb(243, 247, 250) 66.667%, rgb(241, 245, 249) 100%)" }} data-name="App">
      <Container />
    </div>
  );
}
...
function Container24() {
  return (
    <div className="absolute content-stretch flex flex-col h-[97px] items-start left-0 pt-[17px] px-[16px] top-[541px] w-[255px]" data-name="Container">
...
function Navigation() {
  return (
    <div className="absolute h-[410px] left-0 top-[101px] w-[240px]" data-name="Navigation">
      <Link />
      <Button6 />
      <Button7 />
      <Button8 />
...
function Sidebar() {
  return (
    <div className="absolute bg-[#0b3258] h-[739px] left-0 overflow-clip top-0 w-[256px]" data-name="Sidebar">
      <Navigation />
      <Container28 />
      <Container29 />
      <Container30 />
...
export default function SettingSosialMedia() {
  return (
    <div className="bg-white relative size-full" data-name="setting/sosial media">
      <App />
      <TopBar />
      <Sidebar />
    </div>
