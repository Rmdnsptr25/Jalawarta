import svgPaths from "./svg-ke8fe9qruf";
...
function DashboardLayout() {
  return (
    <div className="h-[1935px] relative shrink-0 w-full" style={{ backgroundImage: "linear-gradient(124.922deg, rgb(248, 250, 252) 0%, rgb(248, 250, 252) 50%, rgba(241, 245, 249, 0.3) 100%)" }} data-name="DashboardLayout">
...
function DashboardLayout2() {
  return (
    <div className="absolute bg-[#0b3258] content-stretch flex flex-col h-[1935px] items-start left-0 pr-px top-0 w-[256px]" data-name="DashboardLayout">
...
export default function PagesCreateNew() {
  return (
    <div className="bg-gradient-to-b from-[#f8fafc] relative size-full to-[#f1f5f9]" data-name="pages create new 1">
      <Body />
      <DashboardLayout1 />
      <DashboardLayout2 />
    </div>
