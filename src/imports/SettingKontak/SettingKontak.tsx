import svgPaths from "./svg-uhyirmqz8e";
...
function Icon1() {
  return (
    <div className="absolute left-[16px] size-[16px] top-[14px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_2_8064)" id="Icon">
          <path d={svgPaths.p2a44c680} id="Vector" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
        <defs>
...
function Button1() {
  return (
    <div className="h-[46px] relative rounded-tl-[8px] rounded-tr-[8px] shrink-0 w-[102.516px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon1 />
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[63.5px] not-italic text-[#6366f1] text-[14px] text-center top-[12px] whitespace-nowrap">Kontak</p>
      </div>
    </div>
  );
}
...
function Label() {
  return (
    <div className="h-[20px] relative shrink-0 w-[470.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">EMAIL KONTAK</p>
      </div>
    </div>
  );
}
...
function EmailInput() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[470.5px]" data-name="Email Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[16px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">redaksi@namaberita.com</p>
      </div>
...
function Label1() {
  return (
    <div className="h-[20px] relative shrink-0 w-[470.5px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">NOMOR TELEPON</p>
      </div>
    </div>
  );
}
...
function PhoneInput() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[470.5px]" data-name="Phone Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[16px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">+62 812 3456 7890</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Label2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[965px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">ALAMAT LENGKAP</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[965px]" data-name="Text Area">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start px-[16px] py-[12px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[22px] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Jl. Contoh No. 123, RT 01/RW 02</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Label3() {
  return (
    <div className="h-[20px] relative shrink-0 w-[305.656px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">KOTA</p>
      </div>
    </div>
  );
}
...
function TextInput() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[305.656px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[16px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Jakarta</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Container11() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[72px] items-start left-0 top-0 w-[305.656px]" data-name="Container">
      <Label3 />
      <TextInput />
    </div>
  );
...
function Label4() {
  return (
    <div className="h-[20px] relative shrink-0 w-[305.672px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">PROVINSI</p>
      </div>
    </div>
  );
}
...
function TextInput1() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[305.672px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[16px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">DKI Jakarta</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Container12() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[72px] items-start left-[329.66px] top-0 w-[305.672px]" data-name="Container">
      <Label4 />
      <TextInput1 />
    </div>
  );
...
function Label5() {
  return (
    <div className="h-[20px] relative shrink-0 w-[305.656px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#64748b] text-[12px] top-0 tracking-[0.6px] uppercase whitespace-nowrap">KODE POS</p>
      </div>
    </div>
  );
}
...
function TextInput2() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[305.656px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[16px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">10110</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Container13() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[72px] items-start left-[659.33px] top-0 w-[305.656px]" data-name="Container">
      <Label5 />
      <TextInput2 />
    </div>
  );
...
function Container5() {
  return (
    <div className="h-[376px] relative shrink-0 w-full" data-name="Container">
...
function Container() {
  return (
    <div className="h-[714px] relative shrink-0 w-full" data-name="Container">
...
function App() {
  return (
    <div className="absolute content-stretch flex flex-col h-[714px] items-start left-0 pl-[256px] top-[73px] w-[1351px]" style={{ backgroundImage: "linear-gradient(rgb(248, 250, 252) 0%, rgb(246, 248, 251) 33.333%, rgb(243, 247, 250) 66.667%, rgb(241, 245, 249) 100%)" }} data-name="App">
      <Container />
    </div>
  );
}
...
function Container23() {
  return (
    <div className="absolute content-stretch flex flex-col h-[97px] items-start left-0 pt-[17px] px-[16px] top-[590px] w-[255px]" data-name="Container">
...
function Navigation() {
  return (
    <div className="absolute h-[346px] left-0 top-[101px] w-[240px]" data-name="Navigation">
      <Link />
      <Button6 />
      <Button7 />
      <Button8 />
...
function Sidebar() {
  return (
    <div className="absolute bg-[#0b3258] h-[788px] left-0 overflow-clip top-0 w-[256px]" data-name="Sidebar">
      <Navigation />
      <Container27 />
      <Container28 />
      <Container29 />
...
export default function SettingKontak() {
  return (
    <div className="bg-white relative size-full" data-name="setting/kontak">
      <App />
      <TopBar />
      <Sidebar />
    </div>
