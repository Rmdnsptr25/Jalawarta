import svgPaths from "./svg-m6op8wncpi";

function Icon() {
  return (
    <div className="flex-[1_0_0] h-[20px] min-w-px relative" data-name="Icon">
        ...
        <div className="absolute bottom-[20.83%] left-[20.83%] right-1/2 top-[20.83%]" data-name="Vector">
          <div className="absolute inset-[-7.14%_-14.29%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.5 13.3333">
              <path d={svgPaths.p37c3e100} id="Vector" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
            </svg>
          </div>
        </div>
        <div className="absolute bottom-1/2 left-[20.83%] right-[20.83%] top-1/2" data-name="Vector">
          <div className="absolute inset-[-0.83px_-7.14%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.3333 1.66667">
              <path d="M12.5 0.833333H0.833333" id="Vector" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
            </svg>
          </div>
        </div>
      </div>
...
function Button() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 size-[20px]" data-name="Button">
      <Icon />
    </div>
  );
}
...
function Heading() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-[561.25px]" data-name="Heading 1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[40px] left-0 not-italic text-[#10151c] text-[36px] top-0 whitespace-nowrap">Ekspor Data</p>
      </div>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[28px] relative shrink-0 w-[561.25px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[28px] left-0 not-italic text-[#64748b] text-[18px] top-0 whitespace-nowrap">Ekspor konten Jala Warta ke dalam format XML WordPress (WXR).</p>
      </div>
    </div>
  );
}
...
function Container1() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[76px] items-start relative shrink-0 w-[561.25px]" data-name="Container">
      <Heading />
      <Paragraph />
    </div>
  );
...
function Heading1() {
  return (
    <div className="h-[28px] relative shrink-0 w-[933px]" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[28px] left-0 text-[#10151c] text-[20px] top-0 whitespace-nowrap">Pilih Konten untuk Diekspor:</p>
      </div>
    </div>
  );
}
...
function RadioButton() {
  return <div className="absolute left-[22px] size-[20px] top-[24px]" data-name="Radio Button" />;
}

function Text() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-[311.344px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[24px] left-0 text-[#10151c] text-[16px] top-0 whitespace-nowrap">Semua Konten</p>
      </div>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="h-[20px] relative shrink-0 w-[311.344px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#64748b] text-[14px] top-0 whitespace-nowrap">Mencakup Artikel, Laman, Kategori, dan Media.</p>
      </div>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] h-[48px] items-start left-[58px] top-[22px] w-[311.344px]" data-name="Container">
      <Text />
      <Text1 />
    </div>
  );
...
function Label() {
  return (
    <div className="bg-[rgba(99,102,241,0.05)] h-[92px] relative rounded-[12px] shrink-0 w-[933px]" data-name="Label">
      <div aria-hidden="true" className="absolute border-2 border-[#6366f1] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <RadioButton />
        <Container5 />
      </div>
...
function Text2() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-[269.484px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[24px] left-0 text-[#10151c] text-[16px] top-0 whitespace-nowrap">Hanya Artikel</p>
      </div>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="h-[20px] relative shrink-0 w-[269.484px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#64748b] text-[14px] top-0 whitespace-nowrap">Hanya mengekspor artikel berita (Posts).</p>
      </div>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] h-[48px] items-start left-[58px] top-[22px] w-[269.484px]" data-name="Container">
      <Text2 />
      <Text3 />
    </div>
  );
...
function Label1() {
  return (
    <div className="bg-white h-[92px] relative rounded-[12px] shrink-0 w-[933px]" data-name="Label">
...
function Text4() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-[286.078px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[24px] left-0 text-[#10151c] text-[16px] top-0 whitespace-nowrap">Hanya Laman</p>
      </div>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] h-[48px] items-start left-[58px] top-[22px] w-[286.078px]" data-name="Container">
      <Text4 />
      <p className="font-['Inter:Regular',sans-serif] font-normal h-[20px] leading-[20px] not-italic relative shrink-0 text-[#64748b] text-[14px] w-[286px]">Hanya mengekspor halaman statis (Pages).</p>
    </div>
  );
}
...
function Text5() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-[324.938px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[24px] left-0 text-[#10151c] text-[16px] top-0 whitespace-nowrap">Media Library</p>
      </div>
    </div>
  );
}
...
function Container8() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] h-[48px] items-start left-[58px] top-[22px] w-[324.938px]" data-name="Container">
      <Text5 />
      <p className="font-['Inter:Regular',sans-serif] font-normal h-[20px] leading-[20px] not-italic relative shrink-0 text-[#64748b] text-[14px] w-[325px]">Mengekspor daftar metadata media library Anda.</p>
    </div>
  );
}
...
function Label3() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[12px] w-[933px]" data-name="Label">
      <div aria-hidden="true" className="absolute border-2 border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <RadioButton3 />
        <Container8 />
...
function Container4() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-[933px]" data-name="Container">
...
function Icon1() {
  return (
    <div className="absolute left-[381.83px] size-[20px] top-[18px]" data-name="Icon">
...
function Button1() {
  return (
    <div className="bg-[#1976d2] h-[56px] relative rounded-[12px] shadow-[0px_10px_15px_0px_rgba(99,102,241,0.3),0px_4px_6px_0px_rgba(99,102,241,0.3)] shrink-0 w-[933px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon1 />
        <p className="-translate-x-1/2 absolute font-['Arimo:Bold',sans-serif] font-bold leading-[24px] left-[480.83px] text-[16px] text-center text-white top-[16px] whitespace-nowrap">Unduh File Ekspor</p>
      </div>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] h-[548px] items-start relative shrink-0 w-full" data-name="Container">
      <Heading1 />
      <Container4 />
      <Button1 />
    </div>
    ...
    <div className="h-[24px] overflow-clip relative shrink-0 w-full" data-name="Icon">
      <div className="absolute inset-[8.33%]" data-name="Vector">
        <div className="absolute inset-[-5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
            <path d={svgPaths.pb60700} id="Vector" stroke="var(--stroke-0, #6366F1)" strokeWidth="2" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-1/2 left-1/2 right-1/2 top-[33.33%]" data-name="Vector">
        <div className="absolute inset-[-25%_-1px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2 6">
            <path d="M1 1V5" id="Vector" stroke="var(--stroke-0, #6366F1)" strokeLinecap="round" strokeWidth="2" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[62.5%_45.83%_29.17%_45.83%]" data-name="Vector">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2 2">
          <path d={svgPaths.p39bde000} fill="var(--fill-0, #6366F1)" id="Vector" />
        </svg>
      </div>
    </div>
  );
...
function Container10() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[25px] size-[24px] top-[27px]" data-name="Container">
      <Icon2 />
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="h-[24px] relative shrink-0 w-[941px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[24px] left-0 text-[#10151c] text-[16px] top-0 whitespace-nowrap">Informasi Penting</p>
      </div>
    </div>
  );
}
...
function Container11() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[104px] items-start left-[65px] top-[25px] w-[941px]" data-name="Container">
      <Heading2 />
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[24px] min-h-px not-italic relative text-[#64748b] text-[14px] w-[941px]">File hasil ekspor ini menggunakan standar format WXR. Anda dapat menggunakan file ini untuk memindahkan konten ke instalasi WordPress lain atau CMS lain yang mendukung import WordPress. Data file fisik media library Anda tidak disertakan dalam file XML, melainkan berupa tautan URL yang menunjuk ke server Jala Warta saat ini.</p>
    </div>
  );
}
...
function Container9() {
  return (
    <div className="bg-[rgba(99,102,241,0.05)] h-[154px] relative rounded-[16px] shrink-0 w-[1031px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[rgba(99,102,241,0.2)] border-solid inset-0 pointer-events-none rounded-[16px]" />
      <Container10 />
      <Container11 />
    </div>
  );
...
function Container() {
  return (
    <div className="h-[1056px] relative shrink-0 w-full" data-name="Container">
...
function Navigation() {
  return (
    <div className="absolute h-[366px] left-0 top-[101px] w-[240px]" data-name="Navigation">
      <Link />
      <Button2 />
      <Button3 />
      <Button4 />
...
function Container19() {
  return (
    <div className="absolute content-stretch flex flex-col h-[97px] items-start left-px pt-[17px] px-[16px] top-[1032px] w-[255px]" data-name="Container">
...
function Sidebar() {
  return (
    <div className="absolute bg-[#0b3258] h-[1129px] left-0 overflow-clip top-0 w-[256px]" data-name="Sidebar">
      <Navigation />
      <Container16 />
      <Container17 />
      <Container18 />
...
export default function ToolsExportData() {
  return (
    <div className="bg-white relative size-full" data-name="tools/export data">
      <App />
      <Sidebar />
      <TopBar />
    </div>
